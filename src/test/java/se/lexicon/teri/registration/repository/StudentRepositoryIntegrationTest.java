...
class StudentRepositoryIntegrationTest {
    ...
    void test_findByEmail() {
        Optional<Student> foundStudent = repository.findByEmail("teri@test.se");
        assertEquals(student, foundStudent.get());
    }

    @Test
    void test_findByFirstNameIgnoreCaseAndLastNameIgnoreCase() {
        Optional<Student> foundStudent = repository.findByFirstNameIgnoreCaseAndLastNameIgnoreCase("teri", "sandstedt");
        assertEquals(student, foundStudent.get());
    }
}